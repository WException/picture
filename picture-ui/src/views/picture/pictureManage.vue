  ...
  <div id="pictureManage">
    <a-flex justify="space-between">
      ...
      <a-space>
        ...
        <a-button type="primary" href="/addPicture/batch" target="_blank" ghost>+ 批量创建图片</a-button>
      </a-space>
    </a-flex>
    <!-- 搜索表单 -->
    ...
    >
      <template #bodyCell="{ column, record }">
        ...
        <template v-else-if="column.key === 'action'">
          <a-space wrap>
            <a-button
              v-if="loginUserStore.loginUser.userRole == 'admin' && record.reviewStatus !== PIC_REVIEW_STATUS_ENUM.PASS"
              type="link"
            ...
            <a-button
              v-if="loginUserStore.loginUser.userRole == 'admin' && record.reviewStatus !== PIC_REVIEW_STATUS_ENUM.REJECT"
              type="link"
              danger
